...
function loadpage8() {
  	...
  	var test1 = document.querySelector('.st2');
	if(test1) {
		test1.style.fill = "red";
	}
};

mainGamePlay.addEventListener("click", loadpage3, false);

})();

// var test1 = document.querySelector('#Path_6');
